...
const curriculumMatrix = [
  {
    ...
    topics: [
      ...
      "Single-Qubit & Multi-Qubit Gates ",
      "Quantum Circuits & Bell States ",
      "Deutsch-Jozsa & Grover's Search Algorithm",
      "Week 1 Evaluation: Quiz 1 Milestone"
    ]
  },
  {
    phaseId: "Week 02",
    phaseTag: "WK2_MATH_ML",
    title: "Math Transforms & ML",
    ...
    topics: [
      "Quantum Fourier Transform (QFT) & QPE ",
      "Shor's Factoring & Period-Finding ",
      "Introduction to Machine Learning & Regressions ",
      "Classification Algorithms, KNN & SVM Core ",
      "Week 2 Evaluation: Quiz 2 Milestone"
    ]
  },
  {
    phaseId: "Week 03",
    phaseTag: "WK3_KERN_CAP",
    title: "Kernels & Capstone",
    ...
    topics: [
      "Intro to QML & Variational Quantum Eigensolver ",
      "Quantum Classifiers & QAOA Optimization ",
      "Quantum Support Vector Machines (QSVM) ",
      "PennyLane Integration & Real Execution ",
      "Graduation Capstone: Kepler Exoplanet Challenge"
    ]
  }
];
      ...
      <div className="w-full px-4 sm:px-8 xl:px-16 mx-auto">
        ...
        <div className="mb-8 text-left max-w-5xl space-y-2">
          ...
          <p className="text-sm sm:text-base text-[#849db5] font-normal leading-relaxed max-w-4xl pt-1">
            Explore the comprehensive 3-Week computational curriculum developed by <span className="text-white font-semibold">4i Labs</span>. This streamlined path scales systematically from raw physical mechanics to high-performance Quantum Support Vector Machine (Q-SVM) engineering pipelines.
          </p>
        </div>

        {/* Centered grid responsive flex constraints for 3 entries */}
